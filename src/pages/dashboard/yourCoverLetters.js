...
const YourCoverLetters = () => {
  ...
  return (
    <React.Fragment>
      <div className="dashboard_sections_header"><h3 className="dashboard_main_heading">Your Cover Letters</h3></div>
...
export default YourCoverLetters;
